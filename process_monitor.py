...
def get_processes_info():
    ...
    for process in psutil.process_iter():
        ...
        processes.append({
            ...
            'n_threads': n_threads, 'username': username,'exe': exe,'uids':uids,'space':space
        })
...
if __name__ == "__main__":
    ...
    parser.add_argument("-c", "--columns", help="""Columns to show,
                        ...
                        default="name,username,cpu_usage,memory_usage,create_time,exe,status,nice,uids")
